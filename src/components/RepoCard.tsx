...
export default function RepoCard({ repo }: { repo: any }) {
  const Content = (
    <div className="group relative flex flex-col h-full overflow-hidden rounded-2xl border border-white/10 bg-black/50 shadow-lg shadow-black/30 transition hover:border-white/20">
